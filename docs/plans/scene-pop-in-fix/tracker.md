...
- Engine submodule pointer: `Updated to focused Escape handling engine commit 55a2a8194b4a86b88c5963429004ebe20cee40a3; root pointer commit pending`
- Overall status: `Focused Escape handling fix validated; commit/push pending`
