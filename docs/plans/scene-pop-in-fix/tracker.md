...
- Overall status: `Main-menu placeholder cube preload fix validated; commit/push pending`
...
## Repository State
- Root commit/push state: `Unowned Escape handler guard commits through 1baeee4 pushed to origin/feature/scene-pop-in-investigation; main-menu placeholder cube preload fix pending commit`
