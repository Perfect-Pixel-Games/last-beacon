...
## Repository State
- Root commit/push state: `Settings owner-resolution fix commit 24dc620 pushed to origin/feature/bevy-ui-scenes; final tracker state commit pending.`
...
- Current tweak state: `Settings menu-hide system now resolves scene ownership through parent links so BSN-authored menu roots are hidden correctly; validation passed; checkpoint pushed as 24dc620.`
