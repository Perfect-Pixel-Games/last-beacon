...
## Repository State
- Root commit/push state: `Settings overlay menu-hide commit f9ecc8a pushed to origin/feature/bevy-ui-scenes; final tracker state commit pending.`
...
- Current tweak state: `Settings now hides marked Main Menu/Pause Menu UI roots while preserving the lower cube/gameplay scene; validation passed; checkpoint pushed as f9ecc8a.`
