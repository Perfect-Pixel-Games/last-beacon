...
## Repository State
- Root commit/push state: `Tracker commit 9af6857 pushed to origin/feature/bevy-ui-scenes; settings owner-resolution fix checkpoint pending.`
...
- Current tweak state: `Settings menu-hide system now resolves scene ownership through parent links so BSN-authored menu roots are hidden correctly; validation passed; checkpoint commit pending.`
