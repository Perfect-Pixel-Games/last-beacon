...
- Current tweak state: `Settings menu-hide system now uses UI Node display state instead of scene Visibility so Foundation scene visibility sync cannot reveal the previous menu; validation passed; checkpoint pushed as 1f67ab5.`
