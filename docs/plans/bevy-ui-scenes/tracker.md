...
## Repository State
- Root commit/push state: `Tracker commit 8b18d83 pushed to origin/feature/bevy-ui-scenes; settings display-hide fix checkpoint pending.`
...
- Current tweak state: `Settings menu-hide system now uses UI Node display state instead of scene Visibility so Foundation scene visibility sync cannot reveal the previous menu; validation passed; checkpoint commit pending.`
