...
## Repository State
- Root commit/push state: `Settings display-hide fix commit 1f67ab5 pushed to origin/feature/bevy-ui-scenes; final tracker state commit pending.`
...
- Current tweak state: `Hardening pass completed: strict clippy, full tests, docs, format, and Settings stack smoke launch passed; checkpoint commit pending.`
